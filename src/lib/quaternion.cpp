...
//*************************************************************************************************
qt quaternion_log(qt q){
	return qt(std::log(q.R_component_1()),std::log(q.R_component_2()),std::log(q.R_component_3()),std::log(q.R_component_4()));
}
vec vec_abs(vec q){
	vec q1(std::fabs(q[0]),std::fabs(q[1]),std::fabs(q[2]));
	return q1;
}
qt quaternion_mul(qt q1, qt q2){
	return qt(q1.R_component_1()*q2.R_component_1(),
			  q1.R_component_2()*q2.R_component_2(),
			  q1.R_component_3()*q2.R_component_3(),
			  q1.R_component_4()*q2.R_component_4());
}
qt quaternion_div(qt q1, qt q2){
	return qt(q1.R_component_1()/q2.R_component_1(),
			  q1.R_component_2()/q2.R_component_2(),
			  q1.R_component_3()/q2.R_component_3(),
			  q1.R_component_4()/q2.R_component_4());
